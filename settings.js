...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? '𝙰𝚂𝙸𝚃𝙷𝙰-𝙼𝙳=m6QEkCSQ#An05UXGUlMb6viU4f7gUNq_isc9VigcP1BLETiDqPD4' : process.env.SESSION_ID,
PREFIX: process.env.PREFIX || '.' ,
ALIVE_MSG: process.env.ALIVE_MSG === undefined ? "*⚕️ Hello , I am alive now!! 🪔*" : process.env.ALIVE_MSG,
