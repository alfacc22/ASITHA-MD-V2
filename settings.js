...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? '𝙰𝚂𝙸𝚃𝙷𝙰-𝙼𝙳=G3oWDDKI#UxkLT0pyhDhdWCgevmuLBPTBysDfiMO9C-NwB-vT5QQ' : process.env.SESSION_ID,
PREFIX: process.env.PREFIX || '.' ,
ALIVE_MSG: process.env.ALIVE_MSG === undefined ? "*❤️👋 Hello , I am alive now!! 📍🌬️*" : process.env.ALIVE_MSG,
...
NEWS_JID: process.env.NEWS_JID === undefined ? "120363369325181065@g.us" : process.env.NEWS_JID,
